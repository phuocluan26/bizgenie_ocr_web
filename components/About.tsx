      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center mb-16 fade-in-up">
          ...
          <h2 className="text-3xl md:text-5xl font-bold text-white mb-6">
            Không chỉ là OCR, đó là <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-purple to-brand-light">BizGenie</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 fade-in-up">
          ...
          <div className="p-8 rounded-2xl bg-white/5 border border-white/10 hover:border-brand-purple/50 transition duration-300 text-center group">
          ...
          <div className="p-8 rounded-2xl bg-white/5 border border-white/10 hover:border-brand-orange/50 transition duration-300 text-center group">
          ...
          <div className="p-8 rounded-2xl bg-white/5 border border-white/10 hover:border-blue-400/50 transition duration-300 text-center group">
